...
class PermisoSeeder extends Seeder
{
    public function run()
    {
        ...
        Permission::create(['name' => 'crear_medio_residencias']);
        Permission::create(['name' => 'eliminar_medio_residencias']);
        ...
        Permission::create(['name' => 'crear_medio_habitaciones']);
        Permission::create(['name' => 'eliminar_medio_habitaciones']);
        ...
        $super_usuario->givePermissionTo('crear_medio_residencias');
        $super_usuario->givePermissionTo('eliminar_medio_residencias');
        ...
        $super_usuario->givePermissionTo('crear_medio_habitaciones');
        $super_usuario->givePermissionTo('eliminar_medio_habitaciones');
